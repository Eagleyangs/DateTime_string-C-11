...
const string c_strSys_Format = "%04ld_%02ld_%02ld_%02ld_%02ld_%02ld.%03ld";
...
public:
    ...
    // 获取系统时间
    static string getSystemTimeString(const string sFormat = c_strSysFormat)
    {
        char timeChar[128] = { 0 };
#ifdef _WIN32
        SYSTEMTIME sysTime;
        ...
        if( NULL != pTempTm )
        {
            snprintf(timeChar, 128, "%04d-%02d-%02d %02d:%02d:%02d.%03ld",
